"""
    This file is a part of the Vlasova package, developed by Jorge Gidi for 
...
@assert isfile(simulation_path*"/shared_data.h5") "There is no file shared_data.h5 into $simulation_path/. That file should contain data previously calculated by the simulation."
...
run(`cp $simulation_path/parameters.jl parameters.jl`)
